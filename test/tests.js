...
QUnit.test("FetchTimesheet.execute - two clients on one day multiple entries", function( assert ) {
...
QUnit.test("FetchTimesheet.execute - one client on two days multiple entries", function( assert ) {
